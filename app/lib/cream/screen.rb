...
tl_overview = Tk::Tile::Entry.new(content) {width 7; textvariable $overview}.grid( :columnspan => 4, :row => 0, :sticky => 'we')
# create the calculator inputfield result 
tl_result = Tk::Tile::Entry.new(content) {width 7; textvariable $currvalue}.grid( :columnspan => 3, :row => 1, :sticky => 'we')

# create the button with value backspace
Tk::Tile::Button.new(content) {text '<-'; command {delete1digit}}.grid( :column => 3, :row => 1, :sticky => 'w')

# create the button with value 1
Tk::Tile::Button.new(content) {text '1'; command {add1digit('1')}}.grid( :column => 0, :row => 2, :sticky => 'w')
# create the button with value 2
Tk::Tile::Button.new(content) {text '2'; command {add1digit('2')}}.grid( :column => 1, :row => 2, :sticky => 'w')
# create the button with value 3
Tk::Tile::Button.new(content) {text '3'; command {add1digit('3')}}.grid( :column => 2, :row => 2, :sticky => 'w')
# create the button with value %
Tk::Tile::Button.new(content) {text '%'; command {setaction('%')}}.grid( :column => 3, :row => 2, :sticky => 'w')

# create the button with value 4
Tk::Tile::Button.new(content) {text '4'; command {add1digit('4')}}.grid( :column => 0, :row => 3, :sticky => 'w')
# create the button with value 5
Tk::Tile::Button.new(content) {text '5'; command {add1digit('5')}}.grid( :column => 1, :row => 3, :sticky => 'w')
# create the button with value 6
Tk::Tile::Button.new(content) {text '6'; command {add1digit('6')}}.grid( :column => 2, :row => 3, :sticky => 'w')
# create the button with value -
Tk::Tile::Button.new(content) {text 'x'; command {setaction('x')}}.grid( :column => 3, :row => 3, :sticky => 'w')

# create the button with value 7
Tk::Tile::Button.new(content) {text '7'; command {add1digit('7')}}.grid( :column => 0, :row => 4, :sticky => 'w')
# create the button with value 8
Tk::Tile::Button.new(content) {text '8'; command {add1digit('8')}}.grid( :column => 1, :row => 4, :sticky => 'w')
# create the button with value 9
Tk::Tile::Button.new(content) {text '9'; command {add1digit('9')}}.grid( :column => 2, :row => 4, :sticky => 'w')
...
Tk::Tile::Button.new(content) {text '0'; command {add1digit('0')}}.grid( :column => 0, :row => 5, :sticky => 'w')
# create the button with value ,
Tk::Tile::Button.new(content) {text ','; command {add1digit('.')}}.grid( :column => 1, :row => 5, :sticky => 'w')
# create the button with value =
Tk::Tile::Button.new(content) {text '='; command {setaction('=')}}.grid( :column => 2, :row => 5, :sticky => 'w')
# create the button with value +
Tk::Tile::Button.new(content) {text '+'; command {setaction('+')}}.grid( :column => 3, :row => 5, :sticky => 'w')

# create the button with value c
Tk::Tile::Button.new(content) {text 'c'; command {setaction('c')}}.grid( :column => 1, :row => 6, :sticky => 'w')
